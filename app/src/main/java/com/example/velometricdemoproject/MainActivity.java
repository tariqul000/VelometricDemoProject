...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener, OnMenuItemLongClickListener {
    ...
    private void initToolbar() {
        ...
        if (getSupportActionBar() != null) {
            ...
            getSupportActionBar().setBackgroundDrawable(new ColorDrawable(ContextCompat.getColor(this, R.color.bg_login)));
        ...
        mToolBarTextView.setText("demo apps");
    }
    ...
    public void onMenuItemClick(View clickedView, int position) {
       // Toast.makeText(this, "Clicked on position: " + position, Toast.LENGTH_SHORT).show();
        ...
        if (position == 6){
            ...
            Toast.makeText(this, "you exit from apps", Toast.LENGTH_SHORT).show();
        }
    }
